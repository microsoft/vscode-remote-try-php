...
<body>
    <script>
        function confirmDelete(idEmployee) {
            if (confirm('Bạn có chắc chắn muốn xóa sinh viên này không?')) {
                ...
                window.location.href = 'delete.php?idEmployee=' + idEmployee + '&confirm=yes';
            }
        }
    </script>
    <script>
    ...
    <div class="container">
        ...
        if ($rowcount > 0) {
            ...
            echo "<a href='add.php' class='add-btn'>New employee</a>";
            echo "<table>";
            echo "<tr>
                <th>Image</th>
                <th>ID</th>
            ...
            while ($row = mysqli_fetch_assoc($query)) {
                ...
                echo "<a href='edit.php?idEmployee =" . $row['idEmployee'] . "' class='delete-btn'><i class='fa-solid fa-file-pen fa-sm' style='color: #0288d1;'></i></a>";
                echo "<a href='#' class='delete-btn' onclick='confirmDelete(" . $row['idEmployee'] . ")'><i class='fa-solid fa-trash fa-sm' style='color: #f0284a;'></i></a>";
                echo "</td>";
                echo "</tr>";
            }
