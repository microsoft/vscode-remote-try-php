...
if (isset($_FILES["fileToUpload"])) {
    $targetFile = $uploadDir . generateFileName($_FILES["fileToUpload"]["name"]);
    if ($_FILES["fileToUpload"]["size"] > 2097152) {
        echo "Kích thước tệp tin vượt quá giới hạn cho phép (2MB).";
...
if (!empty($files)) {
    ...
    foreach ($files as $file) {
        ...
        echo '<td><a href="delete.php?filename=' . urlencode($file) . '">Xoá</a></td>';
        echo '</tr>';
    }
