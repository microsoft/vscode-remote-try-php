...
const HeaderCreditStatus = () => {
	...
	const handleClickGetMoreCredits = ( close ) => () => {
		window.open( astraSitesVars.get_more_credits_url, '_blank' );
	...
	const revokeAccessPopup = {
		revokeText: __( 'Revoke Access', 'astra-sites' ),
		moreCreditText: __( 'Get More Credits', 'astra-sites' ),
		moreCreditdesc: __(
	...
	return (
		<>
			...
			<ConfirmationPopup
				...
				title={ __( 'Revoke Access', 'astra-sites' ) }
				description={ `${ __(
				...
				confirmBtnTitle={ __( 'Revoke', 'astra-sites' ) }
				cancelBtnTitle={ __( 'Cancel', 'astra-sites' ) }
