	...
	return (
		...
		>
			<div className="flex items-center justify-start w-full gap-2">
				{ getIcon() }
				<input
					className="!p-0 !mx-0 !border-0 !rounded-none !min-h-0 !shadow-none !leading-[1.375rem] focus:!outline-none focus:!shadow-none w-full text-base placeholder:!text-zip-app-inactive-icon placeholder:!text-base"
					type="text"
