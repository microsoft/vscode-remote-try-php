...
class __TwigTemplate_71b036b7f22592892987288406b287adc5134f8454b897deb37074c64d784d1a extends Template
{
  ...
  <h1 class=\"mailpoet-h1 mailpoet-title\">
    <span>";
        // line 6
        yield $this->extensions['MailPoet\Twig\I18n']->translate("Import");
        yield "</span>
  ...
  ";
        // line 10
        yield from         $this->loadTemplate("subscribers/importExport/import/step_data_manipulation.html", "subscribers/importExport/import.html", 10)->unwrap()->yield($context);
        // line 11
...
";
        // line 25
        yield $this->extensions['MailPoet\Twig\I18n']->localize(["noMailChimpLists" => $this->extensions['MailPoet\Twig\I18n']->translate("No active lists found"), "serverError" => $this->extensions['MailPoet\Twig\I18n']->translate("Server error:"), "select" => $this->extensions['MailPoet\Twig\I18n']->translate("Select", "Form input type"), "wrongFileFormat" => $this->extensions['MailPoet\Twig\I18n']->translate("Only comma-separated (CSV) file formats are supported."), "maxPostSizeNotice" => MailPoetVendor\Twig\Extension\CoreExtension::replace($this->extensions['MailPoet\Twig\I18n']->translate("Your CSV is over %s and is too big to process. Please split the file into two or more sections."), ["%s" =>         // line 30
...
";
    ...
    {
        return array (  107 => 130,  105 => 30,  104 => 25,  98 => 22,  94 => 21,  90 => 20,  85 => 18,  81 => 17,  77 => 16,  70 => 11,  68 => 10,  62 => 7,  58 => 6,  54 => 4,  50 => 3,  45 => 2,  43 => 1,  36 => 2,);
    }
