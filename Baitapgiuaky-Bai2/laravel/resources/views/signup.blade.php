...
<body>
    ...
    <div class="container">
        <div class="container-login">
            ...
            <form action="../../app/Http/Controllers/registeruser.php" method="post" id="loginForm">
                ...
                <button class="container-right-btn1">
                <i class="fa-brands fa-google btn-gg" style="color: #0765ff;"></i>Continue with Google
                </button>
                <br>
                <input class="container-right-input-name" type="text" placeholder="Full Name" name="new-username">
                <br>
                <input class="container-right-input-email" type="email" placeholder="Email" name="new-email">
                <br>
                <input class="container-right-input-pw" type="password" placeholder="Password" name="new-password">
                ...
                <p class="container-right-p3">
                    Already have a account?<a href="login.blade.php"> Login</a>
                </p>
            </form>
            </div>
        </div>
